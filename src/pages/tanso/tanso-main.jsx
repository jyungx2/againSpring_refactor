        ...
        <div className="max-w-7xl mx-auto px-12">
          ...
          >
            ...
            <p className="text-2xl text-primary-90 leading-relaxed">
              ...
              <span className="bg-primary-40 px-3 py-1 rounded text-white">원료</span>,{" "}
              <span className="bg-primary-40 px-3 py-1 rounded text-white">제조 과정</span>,{" "}
            ...
            <p className="text-2xl text-primary-90 mt-8 leading-relaxed">
              ...
              생산에 이르는 과정에서 평균적으로{" "}
              <span className="bg-primary-40 px-3 py-1 rounded text-white font-bold">75g의 이산화탄소</span>
              가 배출된다는 의미입니다.
            </p>
            <p className="text-2xl text-primary-90 mt-8 leading-relaxed">
              ...
              <span className="bg-primary-40 px-3 py-1 rounded text-white">탄소발자국</span>
          ...
          >
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-7xl font-extrabold text-primary-10 mt-6">{totalTanso} kg CO2e</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <h2 className="text-4xl font-bold mb-8 text-center text-secondary-80">어디서 많이 배출할까요?</h2>
            <div className="space-y-8">
              {Object.entries(categoryTanso).map(([key, value]) => (
                <div key={key} className="flex items-center">
                  <span className="w-48 text-xl text-secondary-80">{categoryLabels[key]}</span>
                  ...
                  <span className="text-xl text-secondary-70">{value.toFixed(2)} kg</span>
                </div>
              ))}
            </div>
          </motion.div>
          ...
          >
            <h2 className="text-4xl font-bold mb-8 text-center text-grey-70">주문한 제품 목록</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              {products.map((product) => (
                ...
                >
                  ...
                  />
                  <h3 className="text-2xl font-bold text-grey-80">{product.name}</h3>
