...
function TermsOfService() {
  ...
  // 체크박스(type="checkbox")의 경우, 속성의 밸류는 체크 여부이며, 이는 자동으로 true(체크) 또는 false(체크 x)로 설정
  // watchAll = {
  //   required1: true, // 필수 체크박스 1 체크 여부
  //   required2: false, // 필수 체크박스 2 체크 여부
  //   optional: true, // 선택 체크박스 체크 여부
  // };
